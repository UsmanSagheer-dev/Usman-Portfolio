  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: 'CSS3', icon: '🎨', level: 90, color: 'from-blue-400 to-cyan-500' },
        ...
        { name: 'React.js', icon: '⚛️', level: 90, color: 'from-cyan-400 to-blue-500' },
        { name: 'Next.js', icon: '🔺', level: 85, color: 'from-gray-700 to-gray-900' },
        { name: 'Tailwind CSS', icon: '💨', level: 95, color: 'from-teal-400 to-cyan-500' },
      ]
    },
    {
      title: 'Backend & Database',
      skills: [
        { name: 'Firebase', icon: '🔥', level: 85, color: 'from-yellow-400 to-orange-500' },
        { name: 'MongoDB', icon: '🍃', level: 75, color: 'from-green-400 to-emerald-500' },
        { name: 'Node.js', icon: '🟢', level: 70, color: 'from-green-500 to-green-600' },
      ]
    },
    {
      title: 'Mobile Development',
      skills: [
        { name: 'React Native', icon: '📱', level: 85, color: 'from-purple-400 to-purple-600' },
      ]
    },
    {
      title: 'Testing & Tools',
      skills: [
        { name: 'Git', icon: '📚', level: 85, color: 'from-red-500 to-red-600' },
        { name: 'Prismic', icon: '📝', level: 80, color: 'from-indigo-400 to-purple-500' },
        { name: 'Cypress', icon: '🧪', level: 75, color: 'from-gray-600 to-gray-700' },
      ]
    }
  ];
              ...
              <div key={category.title} className="animate-on-scroll" style={{ animationDelay: `${categoryIndex * 0.2}s` }}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
                  {category.skills.map((skill, skillIndex) => (
                    ...
                    >
                      {/* Glass Card */}
                      <div className="relative h-full p-6 rounded-2xl backdrop-blur-lg bg-card/50 border border-border/50 shadow-xl hover:shadow-2xl transition-all duration-500 group-hover:scale-105 group-hover:-translate-y-2">
                        {/* Gradient Overlay */}
